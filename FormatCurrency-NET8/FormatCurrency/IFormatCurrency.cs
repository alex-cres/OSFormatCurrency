...
{
    [OSInterface(Description = "Formats the decimal based on the locale provided and currency symbol from the locale or provided. Provides a list of the Locales available. Converts a Locale Decimal String (a decimal that was written in in a certain locale) into a valid Decimal.",IconResourceName = "OutSystems.FormatCurrency.resources.logo.png", Name = "FormatCurrency")]
