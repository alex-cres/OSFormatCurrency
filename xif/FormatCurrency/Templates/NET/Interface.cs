...
namespace OutSystems.NssFormatCurrency {
	...
	public interface IssFormatCurrency {
		...
		void MssGetCurrencyFormattedByLocale(string ssLocale, decimal ssDecimal, bool ssHasCurrency, string ssCurrency, bool ssUseNativeDigits, bool ssUseChineseExtendedNumbers, bool ssUseFinancialChinese, out string ssFormattedText);

		/// <summary>
		/// Gets the C# supported Locales and their parametrizations.
		/// </summary>
		/// <param name="ssListofLocals"></param>
		void MssGetLocales(out RLLocaleRecordList ssListofLocals);
		...
		void MssGetDecimalFromLocaleDecimalString(string ssInputLocalelDecimalString, string ssLocale, string ssCurrency, out bool ssIsValidDecimal, out int ssErrorMessageCode, out string ssErrorMessage, out decimal ssDecimal);
